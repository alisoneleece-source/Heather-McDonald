...
/* Tour: two row children only; the icon is INSIDE the ticket label, never a third flex item. */
...
function replaceArrows(){
 /* Each Tour link has exactly two children: the date/time and a compact Tickets + scoop label. */
 ...
 document.querySelectorAll('a,button').forEach(el=>{
  if(el.matches('.performances a'))return;
