...
/* Mirror Contact's compact hero dimensions rather than the old oversized podcast art. */
body.site-podcast .hero{padding:64px 0 0!important}
body.site-podcast .hero .hero-grid{grid-template-columns:minmax(0,1.2fr) minmax(0,.8fr)!important;gap:clamp(14px,3vw,50px)!important;align-items:center!important}
body.site-podcast .hero h1{font-size:clamp(67px,8vw,108px)!important;line-height:.94!important}
body.site-podcast .hero .art.site-podcast-cover-frame{display:flex!important;align-items:flex-end!important;justify-content:center!important;width:100%!important;max-width:410px!important;max-height:430px!important;aspect-ratio:auto!important;height:auto!important;border:0!important;border-radius:0!important;background:transparent!important;overflow:hidden!important;transform:none!important;box-shadow:none!important;margin:0 auto!important}
body.site-podcast .hero .art.site-podcast-cover-frame img{display:block!important;width:100%!important;height:auto!important;max-width:410px!important;max-height:430px!important;object-fit:contain!important;object-position:bottom center!important;border:0!important;border-radius:0!important;transform:none!important}
/* Fill the entire rectangular podcast-cover area, as in the provided reference. */
.episode-panel .podcast-cover{display:block;width:100%;height:220px;object-fit:cover;object-position:center;border-radius:8px;background:#fff;margin:0 0 15px}
/* Keep ticket text and scoop together at the original arrow position. */
.performances a .ticket{display:inline-flex!important;align-items:center!important;justify-content:flex-end!important;gap:5px!important;white-space:nowrap!important;flex:0 0 auto!important}
...
@media(max-width:850px){body.site-podcast .hero .hero-grid{grid-template-columns:1fr!important}body.site-podcast .hero .art.site-podcast-cover-frame{max-width:280px!important;max-height:310px!important}body.site-podcast .hero .art.site-podcast-cover-frame img{max-width:280px!important;max-height:310px!important}}
@media(max-width:700px){header.site-standard>.site-standard-social,header.site-standard>.site-standard-nav{display:none!important}.episode-panel .podcast-cover{height:190px}body.site-podcast .hero{padding:46px 0 59px!important}body.site-podcast .hero h1{font-size:clamp(65px,12vw,90px)!important}}
`;
...
function replaceArrows(){
 /* Tour links are flex rows: placing the scoop on the anchor pushes it to the far edge. Keep it INSIDE the Tickets label. */
 document.querySelectorAll('.performances a .ticket').forEach(ticket=>{const arrow=ticket.querySelector('span[aria-hidden]');if(arrow){arrow.replaceWith(icon());}else if(!ticket.querySelector('.site-scoop-icon'))ticket.appendChild(icon());ticket.classList.add('site-ticket-inline');});
