...
(() => {
  const css = `
    ...
    /* Keep the supplied Scoop artwork intact; scale its container to match button text. */
    .site-scoop-action{gap:7px!important;align-items:center!important;max-width:100%;vertical-align:middle}
