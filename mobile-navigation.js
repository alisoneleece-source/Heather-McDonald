...
siteContinuityScript.addEventListener('load',()=>{const polish=document.createElement('script');polish.src='site-polish.js';document.head.appendChild(polish);},{once:true});
